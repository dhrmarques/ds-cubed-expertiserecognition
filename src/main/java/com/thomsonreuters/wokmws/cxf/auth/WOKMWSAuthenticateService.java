 ...
 * 
 */
@WebServiceClient(name = "WOKMWSAuthenticateService", targetNamespace = "http://auth.cxf.wokmws.thomsonreuters.com", wsdlLocation = "http://search.isiknowledge.com/esti/wokmws/ws/WOKMWSAuthenticate?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://search.isiknowledge.com/esti/wokmws/ws/WOKMWSAuthenticate?wsdl");
