 ...
 * 
 */
@WebServiceClient(name = "WokSearchService", targetNamespace = "http://woksearch.cxf.wokmws.thomsonreuters.com", wsdlLocation = "http://search.isiknowledge.com/esti/wokmws/ws/WokSearch?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WOKSEARCHSERVICE_QNAME = new QName("http://woksearch.cxf.wokmws.thomsonreuters.com", "WokSearchService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://search.isiknowledge.com/esti/wokmws/ws/WokSearch?wsdl");
    ...
    public WokSearch getWokSearchPort() {
        return super.getPort(new QName("http://woksearch.cxf.wokmws.thomsonreuters.com", "WokSearchPort"), WokSearch.class);
    }
    ...
    public WokSearch getWokSearchPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://woksearch.cxf.wokmws.thomsonreuters.com", "WokSearchPort"), WokSearch.class, features);
    }
