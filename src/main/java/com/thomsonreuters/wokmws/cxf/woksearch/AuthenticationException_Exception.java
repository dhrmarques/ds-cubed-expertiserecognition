 ...
 * 
 */
@WebFault(name = "AuthenticationException", targetNamespace = "http://woksearch.cxf.wokmws.thomsonreuters.com")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.thomsonreuters.wokmws.cxf.woksearch.AuthenticationException
     */
